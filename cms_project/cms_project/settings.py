...
SECRET_KEY = 'django-insecure-q881*i_qy7tvhn6=c57#(l6u+*gd0sx0b$!@_y1r@0q0sanpn_'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=1),  # Set expiration time to 1 hour
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),  # Set refresh token expiration time to 7 days
